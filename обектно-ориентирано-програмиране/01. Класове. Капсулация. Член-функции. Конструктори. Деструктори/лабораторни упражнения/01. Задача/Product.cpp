...
Product::Product()
{
	name = new char[2]; // "интервал" + "терминираща нула" = 2 символа
	strcpy_s(name, 2, " ");
...
Product::Product(char* name, char* producer, double price, int width, int height, int depth)
{
...
int Product::setProducer(char* producer)
{
	if (this->producer != nullptr) delete[] this->producer;
